...
<div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8 bg-gradient-to-r from-red-600 to-yellow-500 rounded-2xl shadow-xl p-8 text-white">
            <h2 class="text-2xl font-bold mb-2">Selamat Datang</h2>
            <p class="text-yellow-100">di Sistem Absensi PKL</p>
        </div>
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Sistem Absensi PKL</p>
        </div>
